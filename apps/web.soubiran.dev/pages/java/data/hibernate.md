...
<!-- -   **Disable Auto-DDL**: In production, always set `spring.jpa.hibernate.ddl-auto=validate`. Never let Hibernate modify the schema automatically in production (`update`), as it can lead to data loss or inconsistent states. -->
